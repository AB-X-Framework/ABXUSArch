...
public final class Utils {
	...
	/**
	 * To convert the specified byte array into a UTF-8 encoded text representation.
	 * 
	 * @param bytes
	 * @return
	 */
	...
	/**
	 * To convert the specified byte array into a string with the specified charset.
	 * 
	 * @param bytes
	 * @param charset
	 * @return
	 ...
	 * @param position from where to convert
